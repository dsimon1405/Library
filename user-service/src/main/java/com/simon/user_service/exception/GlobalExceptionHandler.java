package com.simon.user_service.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<Map<String, Object>> requestParameterException(RentException ex, HttpServletRequest httpServletRequest) {
